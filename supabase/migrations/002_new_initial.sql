-- ============================================================
-- VICISSOMETER — Supabase Database Migration (Google Auth Only)
...
-- ============================================================
-- DEFAULT HABITS TRIGGER (Fires when Google User is created)
-- ============================================================
DROP TRIGGER IF EXISTS on_auth_user_created_tr ON auth.users CASCADE;
...
BEGIN
  ...
  INSERT INTO public.profiles (id, username, start_date, target_date, mudras)
  VALUES (
    NEW.id,
  ...
  -- 2. Create the 4 default habits for the new user
  INSERT INTO public.habits (user_id, name, icon, life_outcome, life_outcome_icon, weight, sort_order)
  VALUES
