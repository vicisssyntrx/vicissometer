      ...
      <div className="glass rounded-2xl px-3 py-3">
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className={`flex-none flex flex-col items-center justify-center gap-0.5 rounded-xl px-1 py-2 transition-all w-[60px] sm:w-[72px] ${
              !hasHabits
          ...
          <button
            onClick={onReset}
            disabled={saving}
            className="flex-none flex flex-col items-center justify-center gap-0.5 glass rounded-xl px-1 py-2 text-muted-foreground hover:text-destructive hover:bg-destructive/10 disabled:opacity-50 disabled:cursor-not-allowed transition-all w-[60px] sm:w-[72px]"
          >
